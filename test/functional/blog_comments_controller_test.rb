...
class BlogCommentsControllerTest < ActionController::TestCase
  ...
  test "should create blog_comment" do
    assert_difference('BlogComment.count') do
      post :create, blog_comment: { body: @blog_comment.body, user_blog_id: @blog_comment.user_blog_id, user_id: @blog_comment.user_id }
    end
  ...
  test "should update blog_comment" do
    put :update, id: @blog_comment, blog_comment: { body: @blog_comment.body, user_blog_id: @blog_comment.user_blog_id, user_id: @blog_comment.user_id }
    assert_redirected_to blog_comment_path(assigns(:blog_comment))
  end
